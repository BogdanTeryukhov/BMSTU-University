...
var conf = &firebase.Config{
	DatabaseURL: "https://projectdb-13752-default-rtdb.firebaseio.com/",
}
...
var opt = option.WithCredentialsFile("projectdb-13752-firebase-adminsdk-wn56m-cec0962b72.json")
...
func getLast() block2 {
	client, err := ethclient.Dial("https://mainnet.infura.io/v3/21a30a05fd0a4efdab8fc3c09b4dbe12")
	if err != nil {
		log.Fatalln(err)
	}
