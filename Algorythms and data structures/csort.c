...
void clear_space(char *src);//функция избавления от пробелов
void csort(char *src, char *dest);
void CountSort(int *a, int n, int *count); // из презентации
...
void csort(char *src, char *dest){
    ...
    int count_idx[count_word];
    int count_len[count_word];
